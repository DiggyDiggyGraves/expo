...
- Added `setUpdateRequestHeadersOverride` and deprecated `setUpdateURLAndRequestHeadersOverride`. ([#38623](https://github.com/expo/expo/pull/38623) by [@kudo](https://github.com/kudo))
